...
// import image from "./public/images/t1.jpg";
// import imageteam from "./public/images/t1team.jpg";
...
//             <Image className="w-full h-2/3" src={image} alt="logo" />
//             <Image className="w-full h-1/3" src={imageteam} alt="logo" />
//           </div>
...
//                   />
//                 </div>
//                 <div className="hover:text-blue-400">Tạo tài khoản</div>
//                 <div>
